...
MdPress 由两部分组成：第一部分是一个[极简静态网站生成器](https://github.com/LinFeng1997/mdpress/tree/master/packages/%40mdpress/core)，它包含由 MdPress 驱动的[主题系统](../theme/README.md)和[插件 API](../plugin/README.md)，另一个部分是为书写技术文档而优化的[默认主题](../theme/default-theme-config.md)，它的诞生初衷是为了支持印记中文及其子项目的文档站需求。
