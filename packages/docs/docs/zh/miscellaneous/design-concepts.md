...
有了插件，我们可以将很多核心功能用插件来实现，你可以在[这里](https://github.com/LinFeng1997/mdpress/tree/master/packages/%40mdpress/core/lib/node/internal-plugins)看到很多内置的插件，这些插件涵盖了很多 MdPress 的核心功能，在以前，它们糅合在代码库的各个地方，但现在，它们一目了然。
...
::: warning 注意
当你想要去自定义 `templates/ssr.html` 或 `templates/dev.html` 时，最好基于 [默认的模板文件](https://github.com/LinFeng1997/mdpress/blob/master/packages/%40mdpress/core/lib/app/index.dev.html) 来修改，否则可能会导致构建出错。
:::
...
- [@mdpress/core](https://github.com/LinFeng1997/mdpress/tree/master/packages/@mdpress/core)：包含 dev、build 的核心实现和 Plugin API；
- [@mdpress/theme-default](https://github.com/LinFeng1997/mdpress/tree/master/packages/@mdpress/theme-default)：你现在所看到的默认主题。
