...
// Since MdPress needs to extract the header from the markdown source
...
// HTML in headers, so in MdPress, after being parsed by the markdown
// loader, the raw HTML in headers will finally be parsed by babel-loader.
// so that we can write HTML in the header. One exception is the HTML
