...
exports.getPluginResolver = (cwd) => new ModuleResolver('plugin', 'mdpress', [String, Function, Object], true /* load module */, cwd);
exports.getThemeResolver = (cwd) => new ModuleResolver('theme', 'mdpress', [String], false /* load module */, cwd);
